...
package io.github.chrstjan.widgetsfx.controls
...
class InputActionWidget(
    ...
    private var buttonAction: ButtonRunner = {} // Button logic
    private val actionRunning: BooleanProperty = SimpleBooleanProperty(false) // Tracks if action is running
    ...
    private val tagGapImpl:
            StyleableDoubleProperty = SimpleStyleableDoubleProperty(GAP_META_DATA, this, "tagGap")
    var tagGap: Double
        get() = tagGapImpl.value
        set(value) = tagGapImpl.set(value)

    fun orientationProperty() = orientationImpl
    private val orientationImpl:
            StyleableObjectProperty<Orientation> = SimpleStyleableObjectProperty(ORIENTATION_META_DATA, this, "orientation", Orientation.HORIZONTAL)
    ...
    companion object CssStuff {
        ...
        val ORIENTATION_META_DATA: CssMetaData<InputActionWidget, Orientation> =
            object : CssMetaData<InputActionWidget, Orientation>("-wfx-orientation", EnumConverter(Orientation::class.java)) {
        ...
        private val cssMetaDataList = (Region.getClassCssMetaData() + GAP_META_DATA + ORIENTATION_META_DATA) as MutableList
